...
def main():
    ...
    if page_selection == "Movies EDA":
        ...
        st.image('resources/imgs/ratings_movies.png',use_column_width=True)
        st.write("The movie data set contains 62423 unique movies. On analysis of the movie dataset with the rating dataset, we saw that 23% of the movies were not rated. 20% had single ratings, while 42% were rated between 2 and 50 times. 4% were rated 51 to 100 times, while 8% were rated 101 to 1000 times. And 3% were rated more than 1000 times. Therefore, a large percentage of the movies were unrated. We believe most of these unrated movies are old movies that were released before the rating system started.")
